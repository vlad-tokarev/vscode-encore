...
Encore for VS Code adds source navigation, workspace discovery, local run and debug actions, and Encore Cloud-aware tooling to [Encore Go](https://encore.dev/go) projects.

[![Encore for VS Code demo](https://img.youtube.com/vi/sfwN91Y3Qnc/maxresdefault.jpg)](https://www.youtube.com/watch?v=sfwN91Y3Qnc)
